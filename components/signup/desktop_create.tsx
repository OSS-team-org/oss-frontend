...
const Desktop_Create_Account: React.FC<{
  title?: string;
  hidden?: string;
  toggle: fn;
  ...
  return (
    <div
    className={ `  transition-all   border-red-500   duration-300 ease-in-out  r-0  h-[90vh] w-[25vw] rounded-2xl border-red-300 bg-white px-[24px]  ${
      hide!="create"
        ? " absolute bottom-[-100vh]  invisible opacity-0 "
        : "absolute top-[15px] left-[40%] z-20 z-20  visible opacity-100 "
    }`}
  >
  ...
  >
    ...
    />
        ...
        <div className="  h-[450px] mt-[-20px] flex flex-col justify-between   border-yellow-500  lg:mb-0  lg:mt-0">
          <div className=" border-blue-500 h-[48px]">
            <div className="text-[grey] text-[14px]">An email with a six digit code will be sent to</div>   
            <div className="text text-[14px] font-semibold">yoofi-graham@gmail.com</div>   
                   </div>
...
export default Desktop_Create_Account;
