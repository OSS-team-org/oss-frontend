...
const Mobile_Menu_SignUp: React.FC<{
  title?: string;
  hidden?: string;
  toggle: fn;
  ...
  return (
    ...
    >
        ...
        <div onClick={()=>{toggle("verify");}} className="flex h-[52px] mt-[-40px]  cursor-pointer  items-center justify-center rounded-xl border-green-500 bg-primary-700 text-[23px] text-[white] lg:mb-0 lg:mt-0 lg:h-[48px] lg:text-[15px]">
          Continue
        </div>
      </div>
...
export default Mobile_Menu_SignUp;
