...
const Mobile_Menu_Login: React.FC<{
  ...
  const [hide, setHidden] = useState<string>(hidden);
  useEffect(() => {
    setHidden(hidden);
  }, [hidden]);
  return (
    <div
    className={ `  transition-all   border-red-500   duration-300 ease-in-out  r-0  h-[75vh] w-[25vw] rounded-2xl border-red-300 bg-white px-[24px]  ${
      hide!="signup"
  ...
  >
     ...
     <div className=" h-[134px]  border-red-500 lg:mt-0 lg:h-[134px]  lg:pt-[24px] flex flex-col justify-center items-center">
          <div className="border-green-500 text-[24px] font-bold lg:text-[24px]">
            ...
            <span className="text-[20px] ml-[10px] text-[#333333] ">Sign up to MMAP</span>
            </div>
          </div>
        ...
        <div className="  flex h-[68px]  items-center justify-center border-green-500  text-center  text-[#999999] lg:mb-0 lg:mt-0">
          Or
        </div>
        ...
        <div onClick={()=>{toggle("verify");}} className="flex h-[52px] mt-[-40px]  cursor-pointer  items-center justify-center rounded-xl border-green-500 bg-primary-700 text-[23px] text-[white] lg:mb-0 lg:mt-[-60px] lg:h-[48px] lg:text-[15px]">
          Continue
        </div>
      </div>
