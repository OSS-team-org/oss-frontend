...
const Menu_Login: React.FC<{
  ...
  return (
    <div
      className={ `  transition-all border  border-red-500   duration-300 ease-in-out  r-0  h-[75vh] w-[25vw] rounded-2xl border-red-300 bg-white px-[24px]  ${
        hide!="login"
    ...
    >
        ...
        <div className="  h-[104px] border-blue-500 lg:mt-0 lg:h-[114px]  lg:pt-[5px] flex flex-col justify-center items-center">
          <div className=" w-[100%] border-green-500 text-[24px] font-bold lg:text-[24px]">
        ...
        <div className="h-[80px]   border-red-500  lg:mb-0  lg:mt-0">
        ...
        <div onClick={()=>{toggle("password");}} className="flex h-[52px]  cursor-pointer  items-center justify-center rounded-xl border-green-500 bg-primary-700 text-[23px] text-[white] lg:mb-0 lg:mt-0 lg:h-[48px] lg:text-[15px]">
          Login
        </div>
      </div>
