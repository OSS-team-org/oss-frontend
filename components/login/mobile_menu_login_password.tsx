  ...
  return (
    <div
      className={
        hide
          ? "hidden"
          : "fixed bottom-0 left-0 r-0 z-20 z-20 h-[86.73%] w-[100vw] rounded-t-2xl border-red-300 bg-white px-[24px] "
      }
    >
        ...
        <div className="flex h-[52px] mt-[-40px]  cursor-pointer  items-center justify-center rounded-xl border-green-500 bg-primary-700 text-[23px] text-[white] lg:mb-0 lg:mt-0 lg:h-[48px] lg:text-[15px]">
          Login
        </div>
      </div>
