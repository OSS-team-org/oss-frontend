...
const Mobile_Welcome_Back: React.FC<{
  title?: string;
  hidden?: string;
  toggle: fn;
  ...
  return (
    <div
    className={`md:hidden transition-all border border-red-500   duration-300 ease-in-out r-0 z-20 z-20 h-[368px] w-[100vw] rounded-t-2xl border-red-300 bg-white px-[24px] 
     ${ hide!="welcome"
        ? "absolute bottom-[-100vh]  invisible opacity-0 "
        : "fixed bottom-0 left-0 visible opacity-100"
    }`}
  >
      ...
      <div className="h-[242px] mt-[-20px] flex flex-col justify-between   border-yellow-500  lg:mb-0  lg:mt-0">
        <div className=" border-blue-500 h-[48px]">
          <div className="text-[grey]">You already have an account with you Google account.yoofi-graham@gmail.com</div>   
...
export default Mobile_Welcome_Back;
