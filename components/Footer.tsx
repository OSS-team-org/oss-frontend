      ...
      <footer className="bg-gray-50">
        <div className="mx-auto max-w-5xl space-y-12 px-4 py-16 sm:px-6 lg:px-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="mt-8 flex space-x-6 text-gray-500 sm:mt-0">
              <a
          ...
          <div className="grid grid-cols-1 gap-8 border-t border-gray-100 pt-12 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <nav className="text-sm mt-4 flex flex-col space-y-2 text-gray-500">
          ...
          <p className="text-xs text-gray-500">&copy; 2022 Mentor Connect.</p>
        </div>
      </footer>
    </div>
  );
